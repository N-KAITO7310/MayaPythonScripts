...
created: 2022/03/20?
lastUpdated: ?
description: open or import or reference a file

import nkTools.general.openImportDialogTool as op;
if op.OpenImportDialog.dlg_instance:
	op.OpenImportDialog.show_dialog();
else:
	reload(op)
	op.OpenImportDialog.show_dialog()
"""
