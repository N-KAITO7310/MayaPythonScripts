...
回転をノードにより曲げと捻り回転に分離、またはそのままクォータニオン変換、slerpにより割合を指定して接続を行う

ScriptEditorUse:
from nkTools.rigging import rotationDriverTool;
reload(rotationDriverTool);
reload(rotationDriverTool.qt);
rotationDriverTool.option();
