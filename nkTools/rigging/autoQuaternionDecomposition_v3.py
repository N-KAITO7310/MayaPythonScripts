...
"""
from nkTools.rigging import autoQuaternionDecomposition_v3;
reload(autoQuaternionDecomposition_v3);
reload(autoQuaternionDecomposition_v3.qt);
autoQuaternionDecomposition_v3.option();
"""
