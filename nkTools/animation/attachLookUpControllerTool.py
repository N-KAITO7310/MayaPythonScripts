...
description: 対象オブジェクト(ctrl想定)に対して実行。設定オプションからコントローラーを生成し、aimConstraintを適用。依頼者より要望がなかったためベイク等の機能は実装していない。

created: 2023/02/13
last updated: 2023/02/13

import nkTools.animation.attachLookUpControllerTool as at;
reload(at);
at.showUi();
