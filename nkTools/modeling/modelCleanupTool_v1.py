...
すべてのメッシュデータへのフリーズ、ヒストリ削除、メッシュのクリーンナップコマンド、オプティマイズシーンサイズ、
不要なトランスフォームノード削除
接頭辞を入力して実行で、メッシュ用のフォーマットに沿ったリネーム

# python2
import nkTools.modeling.modelCleanupTool_v1 as modelCleanupTool_v1;
reload(modelCleanupTool_v1);
modelCleanupTool_v1.showUi();

# python3
import nkTools.modeling.modelCleanupTool_v1 as modelCleanupTool_v1;
import importlib;
importlib.reload(modelCleanupTool_v1);
modelCleanupTool_v1.showUi();
