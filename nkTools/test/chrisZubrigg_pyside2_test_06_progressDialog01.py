...
class ProgressTestDialog(QtWidgets.QDialog):
    ...
    def run_progress_test(self):
        ...
        progress_dialog = QtWidgets.QProgressDialog("Waiting to process...", "Cancel", 0, number_of_operation, self);
        ...
        for i in range(1, number_of_operation):
            if progress_dialog.wasCanceled():
                break;
            
            progress_dialog.setLabelText("Processing operation: {} of {}".format(i, number_of_operation));
